...
class DiscriminatorVGG(nn.Module):
    def __init__(self, in_nc, base_nf, input_size, norm_type='batch', act_type='leakyrelu'):
        ...
        features.append(conv_block(curr_nc, base_nf, kernel_size=3, norm_type=None, act_type=act_type, padding=1))
        curr_nc = base_nf
        ...
        for i in range(num_downsample):
            ...
            # Add regular conv
            features.append(conv_block(curr_nc, next_nc, kernel_size=3, stride=1, norm_type=norm_type, act_type=act_type, 
                                       padding=1))

            # Add downsampling conv
            features.append(conv_block(next_nc, next_nc, kernel_size=4, stride=2, norm_type=norm_type, act_type=act_type,
                                       padding=1))
